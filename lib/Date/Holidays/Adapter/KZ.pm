package Date::Holidays::Adapter::KZ;
...
Date::Holidays::Adapter::KZ - an adapter class for Date::Holidays::KZ

=head1 VERSION

This POD describes version 1.14 of Date::Holidays::Adapter::KZ

=head1 DESCRIPTION

The is the adapter class for L<Date::Holidays::KZ>.
