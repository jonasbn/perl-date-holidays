package Date::Holidays::Adapter::SK;
...
sub holidays {
    ...
    my $sub = $self->{_adaptee}->can('sk_holidays');
...
sub is_holiday {
    ...
    my $sub = $self->{_adaptee}->can('is_sk_holiday');
...
Date::Holidays::Adapter::SK - an adapter class for Date::Holidays::SK

=head1 VERSION

This POD describes version 1.14 of Date::Holidays::Adapter::SK

=head1 DESCRIPTION

The is the adapter class for L<Date::Holidays::SK>.
